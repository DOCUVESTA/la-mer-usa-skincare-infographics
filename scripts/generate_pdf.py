...
class CustomPDF(FPDF):
    ...
    def initiate_pdf(self):
        width = 960
        height = 540
        self.add_font('League_bold', '', 'assets/League_bold.ttf', uni=True)
    ...
    def use_custom_background(self):
        self.image('assets/lamer_background.png', w=960-10, h=540-10)
    ...
    def add_age_distribution_bar_plot(self):
        age_dist_graph = 'assets/lamer_age_dist_plot_bar.png'
        self.set_xy(0,0)
